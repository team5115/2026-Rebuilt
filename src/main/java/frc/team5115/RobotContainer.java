...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        bindings = new Bindings(drivetrain);
        faults = new RobotFaults(drivetrain, bindings::joysticksConnected);
    ...
    public void robotPeriodic() {
        ...
        //     Logger.recordOutput(
        //             "ShooterData/SuccessfulSpeed",
        // RotationsPerSecond.of(blindSpeedSupplier.getAsDouble()));
