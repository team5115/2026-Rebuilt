...
public class Shooter extends SubsystemBase implements MotorContainer {
    ...
    private static final double constantA = 70d; // squared term
    private static final double constantB = 13.5d; // linear term
    private static final double constantC = 2100d; // 1950d; // y intercept
